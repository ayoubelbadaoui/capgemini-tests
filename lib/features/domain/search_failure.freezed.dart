...
abstract class $SearchFailureCopyWith<$Res> {
  factory $SearchFailureCopyWith(
    SearchFailure value,
    $Res Function(SearchFailure) then,
...
class __$$SearchFailureImplCopyWithImpl<$Res>
    extends _$SearchFailureCopyWithImpl<$Res, _$SearchFailureImpl>
...
class _$SearchFailureImpl implements _SearchFailure {
  const _$SearchFailureImpl({this.errorMsg});
  ...
  @override
  String toString() {
    return 'SearchFailure(errorMsg: $errorMsg)';
  }
...
abstract class _SearchFailure implements SearchFailure {
  const factory _SearchFailure({final String? errorMsg}) = _$SearchFailureImpl;
